import asyncio, async_timeout, copy, datetime, discord, math, random, re, typing, wavelink, sys
...
class Player(wavelink.Player):
    ...
    def build_embed(self) -> typing.Optional[discord.Embed]:
        ...
        embed = discord.Embed(title=f'{Name} Music Controller | {channel.name}', colour=Default_Color)
